...
%  function to draw Wiener cascade model with a polynomial approximation to
% a half-wave rectifier as its nonlinearity, and the same first-order
%  Volterra kernel as the LNL model of the auditory processing example
%  system used as a running example throughout chapter 4 of:
%
...
% Calling figure06, or figure06(1) uses the default NLID toolbox plot
% routines. figure06(2) uses MATLAB handle graphics to dress things up a
% bit.
