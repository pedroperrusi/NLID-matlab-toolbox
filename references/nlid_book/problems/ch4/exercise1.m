...
disp(['Wiener Cascade: ' num2str(t_wiener)])
disp(['Volterra Series: ' num2str(t_vseries)])

vaf(y,yvs)


ws1 = wseries(ch4_wiener,'variance',1);
kern1s = get(ws1,'elements');

ws2 = wseries(ch4_wiener,'variance',2);
kern2s = get(ws2,'elements');

ws10 = wseries(ch4_wiener,'variance',10);
