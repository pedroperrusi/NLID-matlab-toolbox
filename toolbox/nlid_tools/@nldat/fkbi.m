function [Y,dyda]=fkbi(T,a)
%  [y,dyda]=fkbi(x,a) - compute second-order IRF for K,B,I
%
%  Compute second order  2nd order compliance IRF for K,B,I
