...
wkernels = get_nl(ws,'elements');
Ts = get_nl(wkernels{1},'domainincr');
sigma2 = get_nl(ws,'variance');
Nlags = get_nl(ws,'NLags');
Q = get_nl(ws,'OrderMax');
...
old_order = get_nl(kern,'order');
new_order = old_order - 2;
Nlags = get_nl(kern,'NLags');
