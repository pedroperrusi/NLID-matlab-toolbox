...
% VAF function for IRF class models
%
% vf = vaf(model,data)
% vf = vaf(model,input,output)
%
% where model is any model of class irf
...
if nargin == 1
  error('I/O data must be supplied if first argument is of class IRF');
end
