...
accel = get_nl(m0,'accel');
decel = get_nl(m0,'decel');
NumIts2 = get_nl(m0,'InnerLoop');
NumIts1 = get_nl(m0,'MaxIts');
step_size = get_nl(m0,'step');
